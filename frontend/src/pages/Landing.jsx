  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-purple-50 text-gray-800">
        ...
        <div
          id="stats"
          className="bg-gradient-to-r from-blue-50 via-purple-50 to-blue-50 py-20 px-4 sm:px-8 md:px-24 animate-gradient"
        >
            ...
            <div className="text-center mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="feature-card bg-white p-6 sm:p-8 rounded-2xl shadow-lg"
                  >
                    <h3 className="text-4xl sm:text-6xl font-bold gradient-text mb-2">
                      {stat.value}
                    </h3>
